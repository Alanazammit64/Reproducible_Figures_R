...
*Upload your RProject you created for **Question 2*

*GitHub link:* [Link to my repository on Github](https://github.com/mimzy64/Reproducible_Figures_R)

Above is the link to my github repository, containing all necessary files and folders


### b) Share your repo with a partner, download, and try to run their data pipeline.

*Partner's GitHub link:* [Link to my partner's repository on Github](https://github.com/pepperepperepper/reproducible_figures_assignment)

Above is my partner's link 


### c) Reflect on your experience running their code. (300-500 words)

-   *What elements of your partner's code helped you to understand their data pipeline?*
My parnter included lots of text inbetween their code using hashtags within the code blocks to detail what they were doing. This made it clear to me what was being done at each stage, and allowed me to follow along with their pipeline. For example, in the introduction when beginning to work with the Palmer Penguins dataset, they used subtitles such as '# Load the data' and '# Load the functions files into the document' to tell the reader what they were doing with every piece of code. Furthermore, by using functions, their code was kept simple and clean in the Rmarkdown file. This allowed me to follow along with what they were doing without becoming overwhelmed by an unnecessary amount of code in between text. For example, their pre-prepared cleaning functions simply had to be loaded in using the code 'source("functions/cleaning_penguins.r")', for them to be used to clean the dataset as desired. 
